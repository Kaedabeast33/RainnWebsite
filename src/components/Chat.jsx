  ...
  return (
    <div className="flex flex-col  w-[100vw] max-w-[100%] relative mt-5">
      <div className="flex w-[100vw]  items-center justify-center">
        ...
        <div className={`hidden sm:block py-4 py-2 max-h-[200px]   shadow-md w-[fit-content] h-[fit-content] rounded rounded-full  px-2 sm:px-10 flex items-center min-w-[200px] absolute  ${lr} ${color}  h-[50px]`}> 
          <p className="text-[14px] lg:text-[24px]">{text}</p>
        </div>
        <div className={` sm:hidden py-2 max-h-[200px] max-w-[250px]  shadow-md w-[fit-content] h-[fit-content] rounded rounded-full  px-2  flex items-center absolute  ${lr==="left-40"?"left-[65px]":"right-10"} ${color}  h-[50px]`}> 
          <p className="text-[14px] lg:text-[24px]">{text}</p>
        </div>
