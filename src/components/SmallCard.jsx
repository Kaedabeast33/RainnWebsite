...
const SmallCard = ({title,description,button,bg,link,onClick}) => {
  console.log(link)
  return (
        <div  style={{backgroundImage:`url(${bg})`,backgroundRepeat:"no-repeat",backgroundPosition:"center",backgroundSize:"cover"}} className='SmallCard relative min-h-[fit-content] py-2 h-[300px] sm:h-[360px] w-full sm:w-[300px]  px-10 sm:p-4  overflow-hidden '>
