...
const Chat = () => {
  ...
  return (
    <div className='relative'>
      ...
      <section className="LiveChat h-[90vh] overflow-x-auto  flex flex-col gap-[40px] sm:gap-[100px]">
        
        
       {chats.map((chat)=> <ChatBox text={chat.text} lr={chat.lr}/>) }
       <ChatBox text="..." lr={"left-60"} />
      </section>
      <section className='Input fixed bottom-0 flex justify-center items-center bg-[#E9E4F0] h-[120px]    bottom-0 '>
