...
const GetHelp = () => {
  ...
  return (
    ...
    <WarningBanner/>
      ...
      <h2 className='text-center text-white text-[48px] z-30'>Help is Available</h2>
        <div className='z-30 h-full flex gap-2 sm:gap-10 justify-center items-center'>
      ...
      <section className='InfoSection flex sm:flex-row flex-col items-center justify-center sm:p-4 gap-4'>
      ...
      <section className='flex flex-col items-center gap-4 justify-center'>
        <h2 className='text-[14px] sm:text-[36px] px-32 sm:px-0 text-center my-4 w-[60%] min-w-[500px]'>We promise you a safe, free, and confidential experience. Click to learn more about how we protect your privacy. </h2>
      ...
      <section className='Stories    '>
        ...
        <div  className='relative '>
            <div className='sm:hidden absolute w-full h-[100px] bottom-[50%] translate-y-[50%] flex justify-between items-center z-40'>
                <div className='text-white' onClick={onNavigateSotryClickLeft}>{"<"}</div>
                <div className='text-white' onClick={onNavigateClickRight}>{">"}</div>
            </div>
            <motion.div  transition={{duration:0.3}} initial={{translateX:"0"}} animate={{translateX:`${-navigateStory}00%`}} className="sm:hidden flex py-4 w-full sm:justify-center  relative sm:gap-4">
